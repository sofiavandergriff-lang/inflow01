    ...
    <div className="min-h-screen flex">
        ...
        <div className="max-w-md mx-auto w-full">
          ...
          <div className="grid grid-cols-2 gap-4 mb-8">
            <button
              ...
              className="flex items-center justify-center px-4 py-3 bg-white border border-gray-300 rounded-xl text-gray-700 font-medium hover:bg-gray-50 transition-all duration-200 shadow-sm hover:shadow-md"
            >
            ...
            <button className="flex items-center justify-center px-4 py-3 bg-white border border-gray-300 rounded-xl text-gray-700 font-medium hover:bg-gray-50 transition-all duration-200 shadow-sm hover:shadow-md">
              <svg className="w-5 h-5 mr-2" viewBox="0 0 24 24">
      ...
      <div className="hidden lg:flex flex-1 bg-gradient-to-br from-blue-600 via-blue-700 to-blue-800 relative overflow-hidden">
        ...
        <div className="flex flex-col justify-center items-center text-center px-12 relative z-10">
          ...
          {/* Dashboard Preview */}
          <div className="w-full max-w-2xl bg-white/95 backdrop-blur-sm rounded-2xl shadow-2xl p-6 transform rotate-1 hover:rotate-0 transition-transform duration-500">
            {isLogin ? (
              // Login Dashboard
